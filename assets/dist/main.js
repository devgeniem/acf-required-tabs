...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(acf, jQuery) {'use strict';
	...
	var RequiredTabs = function () {

	    /**
	     * An empty constructor.
	     */
	    function RequiredTabs() {
	        (0, _classCallCheck3.default)(this, RequiredTabs);
	    }
	    ...
	    (0, _createClass3.default)(RequiredTabs, [{
	        ...
	        key: 'changeCSS',
	        value: function changeCSS(stylesheet, selector, newRule, newValue) {
	            var thisCSS = void 0,
	                target = void 0;
	            ...
	            try {
	                for (var _iterator = (0, _getIterator3.default)(document.styleSheets), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	            ...
	            try {
	                for (var _iterator2 = (0, _getIterator3.default)(ruleSearch), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
